                            ...
                            <div className="product-main-card" key={p.id} onClick={() => { setProd(p) }}>
                                ...
                                <div className="product-main-details">
                                    ...
                                    <div className="product-main-actions">
                                        ...
                                        <button 
                                            className={`action-button secondary-action ${isInFavorites(p.id) ? 'active' : ''}`}
                                            onClick={(e) => { 
                                                e.stopPropagation();
                                                toggleFavorite(p);
                                            }}
                                        >
                                            {isInFavorites(p.id) ? <FavoriteIcon className="heart-icon active" /> : <FavoriteBorderIcon className="heart-icon" />}
                                        </button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="dialog-content">
                            ...
                            <div className="dialog-details">
                                ...
                                <div className="dialog-actions">
                                    ...
                                    >
                                        {isInFavorites(prod.id) ? <FavoriteIcon className="heart-icon active" /> : <FavoriteBorderIcon className="heart-icon" />}
                                    </button>
                                </div>
                                
                                {/* {showDateError && (
                                    <div className="notification error">
                                        <CalendarTodayIcon /> המוצר אינו זמין כעת. חוזר בתאריך {new Date(prod.dayTaken).toLocaleDateString()}
                                    </div>
                                )} */}
                                {showAddSuccess && (
